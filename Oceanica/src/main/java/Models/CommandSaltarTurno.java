 ...
 * @author lacay
 */
public class CommandSaltarTurno extends Command{

    public CommandSaltarTurno(String[] args) {
        super(CommandType.SALTARTURNO, args);
    }

    @Override
    public void processForServer(ThreadServidor threadServidor) {
        CommandUnicast comandoARealizar = new CommandUnicast("SALTARTURNO", "x", "y", threadServidor.name);
        ...
        CommandSaltarTurno broadcastCommand = new CommandSaltarTurno(broadcastParams);
